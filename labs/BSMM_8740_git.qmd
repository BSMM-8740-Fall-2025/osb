...
5.  Copy and paste the URL of your assignment repo (the clipboard copy you made in step 4) into the dialog box *Repository URL*. Tab to the next text box and the project directory name should be automatically populated, but **make sure you select a directory** in *Create project as a subdirectory of*.
...
::: callout-important
In each lab, quiz, and exam you'll sign into your personal repository on the course organization site at [BSMM-8740-Fall-2023](https://github.com/BSMM-8740-Fall-2023/ "Course GitHub organization") on GitHub and open the Quarto (\``` .qmd` ``) file there, change the [author name to your name]{.underline}, [set the date field in the YAML]{.underline}, and render the document to ensure that your code executes properly.
:::
...
To make sure all the changes went to GitHub. Go to your GitHub repo (at the course site) and refresh the page. You should see your commit message next to the updated files. If you see this, all your changes are on GitHub and you're good to go!
