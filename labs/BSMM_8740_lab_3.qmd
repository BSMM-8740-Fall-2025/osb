...
Use these 5 step in the proper order to create a recipe to pre-process the time series data for each region. Prep and then bake your recipe using `df`.
...
#| echo: false
rec <- 
  recipe(sales_volume ~ ., data = uk_prices |> janitor::clean_names()) |> 
...
rec |> bake(uk_prices |> janitor::clean_names()) %>%
