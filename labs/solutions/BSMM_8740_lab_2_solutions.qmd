...
This matches up with the data from [macrotrends](https://www.macrotrends.net/2526/sp-500-historical-annual-returns). What we've is just calculated based on the stock price only and does not include dividends (so it is not the total return). Note that the data for 2023 and 2018 is incomplete in the dataset.

![](images/Screen%20Shot%202023-09-27%20at%203.22.23%20PM.png){fig-align="center" width="650"}
