...
```{r}
# DAT0
# fit the model for demand0 ~ price0
...
```{r}
# plot the data and the fit for demand0 ~ price0
dat0 %>% ggplot(aes(x=price0,y=demand0)) +
  ...
  geom_abline(
    ...
    , colour = "red"
  ) + labs(title = "data and the fit for demand0 ~ price0")
```
...
```{r}
# plot the data and the fit for demand1 ~ price1
dat1 %>% ggplot(aes(x=price1,y=demand1)) +
  ...
  geom_abline(
    ...
    , colour = "red"
  ) + labs(title = "data and the fit for demand1 ~ price1")
```
