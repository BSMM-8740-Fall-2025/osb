...
-   Please go to the [course website](https://bsmm-8740-fall-2024.github.io/osb/) to review the weekly slides, access the labs, read the syllabus, etc.
...
-   In the lab we will introduc Git and the data backup workflows.
:::
