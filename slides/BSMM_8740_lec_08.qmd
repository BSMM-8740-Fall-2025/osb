...
Consider data tracks life expectancy and GDP per capita in many countries over time.
...
and: grouping by country, and estimating the effect of GDP percapita on life expectancy, controlling for country.
...
ggplot(mmdata,aes(x=year,y=robberyper1000,
  ...
  geom_line(size=1) + ggthemes::scale_color_colorblind(name="Reform")+
