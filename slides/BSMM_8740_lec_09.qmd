...
For metropolis, th key was that the Markov chain was reversible, i.e. $\pi(x)\mathbb{P}(x,y)=\pi(y)\mathbb{P}(y,x)$
...
and $\pi(x)\mathbb{P}(x,y)$ is still symmetric, even if $q$ wasn't
