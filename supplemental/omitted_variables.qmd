...
$$ and the factor in the brackets is greater than 1 and as bofore $\frac{\text{Cov}\left(\tilde{x},y\right)}{\text{Var}\left(\tilde{x}\right)}$ has the same sign as $\beta_1$ so
